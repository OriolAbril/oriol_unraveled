...
::::{grid} 1 1 2 2
:::{grid-item}
![Initial layout of the blog homepage, the snorkeling image takes all the screen](../post_images/bb_home.png)
:::
:::{grid-item}
...
![3d waterfall-type plot of a MOM prior which has a volcan-like shape](../post_images/gmom_pdf_arrow.png)
